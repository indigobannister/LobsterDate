...
In 2012, mean lobster size differed significantly between MPA and non-MPA sites (t(`r round(size_ttest_2012$parameter, 2)`) = `r round(size_ttest_2012$statistic, 2)`, *p* `r ifelse( 0.001 > size_ttest_2012$p.value, "< 0.001", paste("= ", round(size_ttest_2012$p.value,4)))`).

In 2018, mean lobster size also differed significantly between MPA and non-MPA sites (t(`r round(size_ttest_2018$parameter, 2)`) = `r round(size_ttest_2018$statistic, 2)`, *p* `r ifelse( 0.001 > size_ttest_2018$p.value, "< 0.001", paste("= ", round(size_ttest_2018$p.value,4)))`).

Between MPA sites, we do see a significant difference in mean lobster sizes between 2012 and 2018 (t(`r round(ttest_MPA$parameter, 2)`) = `r round(ttest_MPA$statistic, 2)`, *p* `r ifelse( 0.001 > ttest_MPA$p.value, "< 0.001", paste("= ", round(ttest_MPA$p.value,4)))`).
